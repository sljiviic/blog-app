...
<!--
TODO (in your own words, 1-2 sentences):
What the app is and who it's for. E.g. "A full-stack blogging platform where
developers publish articles, and like, save and comment on each other's posts."
Avoid marketing tone — write developer to developer.
-->

<!--
TODO: links once deployed. Delete this block if there's no demo yet.
**Live demo:** https://...
-->
...
<!--
TODO: 2-4 images (feed, post detail, profile, mobile view).
Easiest way: create a `docs/` folder, drop the images in, then link them:
![Feed](docs/feed.png)
Screenshots matter most for someone skimming the project in 20 seconds.
-->
...
| Cloudinary | image upload and optimization (unsigned upload, `f_auto`/`q_auto` transformations) |
...
You'll need Node.js and a PostgreSQL database (a free Neon project works).
...
> Note: restart the backend after every Prisma migration so the process picks up
> the newly generated Prisma client.
...
<!--
TODO (optional, but worth it):
A "What I'd add next" or "What I learned" section — 3-4 bullets in your own words.
Employers read it because it shows self-awareness and how you think.
E.g. component tests, code splitting, feed pagination, dark mode.
-->
